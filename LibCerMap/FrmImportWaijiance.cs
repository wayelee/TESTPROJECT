...
namespace LibCerMap
{
    public partial class FrmImportWaijiance : OfficeForm
    {
        ...
        public FrmImportWaijiance(AxMapControl mcontrol, AxTOCControl mtoccontrol)
        {
            InitializeComponent();
        ...
        private void btnOpenXML_Click(object sender, EventArgs e)
        {
            ...
            if (XMLPath.Contains("三桩"))
            {
                textBoxX3.Text = ClsGDBDataCommon.GetParentPathofExe() + @"Resource\MapTemplate\三桩.mxd";
            }
            else if (XMLPath.Contains("缺陷点"))
            {
                textBoxX3.Text = ClsGDBDataCommon.GetParentPathofExe() + @"Resource\MapTemplate\外防腐层缺陷点.mxd";
            }
        }
        ...
        //将线添加到图层
        private void AddFeature(IFeatureLayer pFeatureLayer, List<IPolyline> lineList)
        {
        ...
        private void FrmImportWaijiance_Load(object sender, EventArgs e)
        {
            textBoxX3.Text = ClsGDBDataCommon.GetParentPathofExe() + @"Resource\MapTemplate\三桩.mxd";
        }
