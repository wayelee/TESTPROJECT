...
namespace LibCerMap
{
    public partial class FrmDuiqiNeijian : OfficeForm
    {
        ...
        public FrmDuiqiNeijian(AxMapControl mcontrol, AxTOCControl mtoccontrol)
        {
            InitializeComponent();
        ...
        private void buttonX_ok_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("拐点距离阈值大于10米，精度低于预期，不能用来进行对齐");
                return;
            }
            Thread.Sleep(4000);
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                textBoxX2.Text = "C:\\Users\\analyse\\Desktop\\zq\\data\\内检测、中线示例数据-对齐\\对齐\\内检测结果对齐.shp";
            }
        }
