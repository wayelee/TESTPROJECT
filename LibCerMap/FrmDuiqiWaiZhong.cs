...
namespace LibCerMap
{
    public partial class FrmDuiqiWaiZhong : OfficeForm
    {
        ...
        public FrmDuiqiWaiZhong(AxMapControl mcontrol, AxTOCControl mtoccontrol)
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                textBoxX2.Text = "C:\\Users\\analyse\\Desktop\\zq\\data\\内检测、中线示例数据-对齐\\对齐\\三桩偏移_中线成果点_外检中线对齐.shp";
            }
        }        
    }
}
