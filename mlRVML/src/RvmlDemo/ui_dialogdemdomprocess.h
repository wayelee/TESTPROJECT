...
**
** Created: Wed Feb 8 09:19:29 2012
...
public:
    ...
    void setupUi(QDialog *DialogDEMDOMProcess)
    {
        ...
        doubleSpinBoxRightBottomY->setValue(200);
        ...
        doubleSpinBoxRightBottomX->setValue(200);
        ...
        doubleSpinBoxSampleCoef->setValue(1);
