...
bool CmlSatMapProj::SatMapping( string projPath, string demPath, string domPath, DOUBLE dRes, bool bBaseFlag, bool bUsePts )
{
    ...
    string sTempPath,sLPtsPath,sRPtsPath,sLDPtsPath,sRDPtsPath,sLimgName,sRimgName,sLogPath;
    ...
    sLogPath = sTempPath + "log.txt";
    SCHAR sLogName[256]= "";
    memcpy(sLogName,sLogPath.c_str(),sLogPath.size());
    mlSetLogFilePath(sLogName);
