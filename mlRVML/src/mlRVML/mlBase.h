...
#define LOGAddSuccessQuitMsg( )         if( g_clsLog.m_bIsValid == true ){ g_clsLog.AddSuccessQuitMsg( __FUNCTION__, __FILE__, __LINE__ );};
#define LOGAddErrorMsg( strMsg )        if( g_clsLog.m_bIsValid == true ){ g_clsLog.AddErrorMsg( strMsg, __FUNCTION__, __FILE__, __LINE__ );};
#define LOGAddExceptionMsg( strMsg )    if( g_clsLog.m_bIsValid == true ){ g_clsLog.AddExceptionMsg( strMsg, __FUNCTION__, __FILE__, __LINE__ );};
#define LOGAddNoticeMsg( strMsg )       if( g_clsLog.m_bIsValid == true ){ g_clsLog.AddNoticeMsg( strMsg, __FUNCTION__, __FILE__, __LINE__ );};
#else
