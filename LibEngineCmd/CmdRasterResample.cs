...
{
    /// <summary>
    /// Summary description for CmdRasterResample.
    /// </summary>
    [Guid("2d76394b-1c11-4532-9d16-cc0846a8b9c5")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("CustomCE.CmdRasterResample")]
    public sealed class CmdRasterResample : BaseCommand
    {
        ...
        public FrmRasterResample m_frmRasterResample = null;

        public CmdRasterResample()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "CustomCE"; //localizable text
            base.m_caption = "栅格图像重采样";  //localizable text
            base.m_message = "栅格图像重采样";  //localizable text 
            base.m_toolTip = "栅格图像重采样";  //localizable text 
            base.m_name = "CustomCE.CmdRasterResample";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
