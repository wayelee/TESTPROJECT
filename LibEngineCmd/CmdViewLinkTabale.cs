...
namespace LibEngineCmd
{
    ...
    /// </summary>
    [Guid("a23741a4-4ca7-4585-9449-cbca52c15b3a")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("CustomCE.CmdViewLinkTabale")]
    public sealed class CmdViewLinkTabale : BaseCommand
    {
        ...
        public CmdViewLinkTabale()
        {
            ...
            base.m_name = "CustomCE.CmdViewLinkTabale";   //unique id, non-localizable (e.g. "MyCategory_MyTool")
        ...
        public override void OnClick()
        {
            ...
            m_ToolAddControlPoints.m_FrmLinkTableRaster.Show();
