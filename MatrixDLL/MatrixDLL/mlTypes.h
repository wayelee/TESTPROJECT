...
#if ( defined WIN32 || defined _WIN32 || defined WIN64 || defined _WIN64 ) && defined ML_MAT_TRANS_EXPORTS
#define ML_MAT_TRANS_EXPORTS __declspec(dllexport)
#else
#define ML_MAT_TRANS_EXPORTS
#endif

#ifndef MLAPI
#define MLAPI(rettype) ML_EXTERN_C ML_MAT_TRANS_EXPORTS rettype ML_CDECL
#endif
